...
describe('CommandParser', () => {
    describe('tokenize', () => {
        it('should tokenize simple command', () => {
            const tokens: string[] = tokenize('cat file.txt');
            expect(tokens).to.deep.equal(['cat', 'file.txt']);
        });

        it('should tokenize command with flags', () => {
            const tokens: string[] = tokenize('ls -la /tmp');
            expect(tokens).to.deep.equal(['ls', '-la', '/tmp']);
        });

        it('should handle single quotes', () => {
            const tokens: string[] = tokenize("echo 'hello world'");
        ...
        it('should handle pipe character', () => {
            const tokens: string[] = tokenize('cat file.txt | grep error');
            expect(tokens).to.deep.equal(['cat', 'file.txt', '|', 'grep', 'error']);
        });

        it('should handle multiple pipes', () => {
            const tokens: string[] = tokenize('cat file.txt | grep error | sed s/a/b/g');
    ...
    describe('parsePipeline', () => {
        it('should parse single command', () => {
            const pipeline: PipelineSegment[] = parsePipeline('cat file.txt');
        ...
        it('should parse two commands with pipe', () => {
            const pipeline: PipelineSegment[] = parsePipeline('cat file.txt | grep error');
        ...
        it('should parse three commands with pipes', () => {
            const pipeline: PipelineSegment[] = parsePipeline('cat file.txt | grep error | sed s/a/b/g');
        ...
        it('should handle quoted strings in pipeline', () => {
            const pipeline: PipelineSegment[] = parsePipeline('echo "hello world" | grep hello');
            expect(pipeline).to.have.lengthOf(2);
    ...
    describe('parseHeredoc', () => {
        it('should detect HEREDOC', () => {
            const result: HeredocParseResult | null = parseHeredoc('cat << EOF');
        ...
        it('should detect HEREDOC with different delimiter', () => {
            const result: HeredocParseResult | null = parseHeredoc('grep error << END');
            expect(result).to.not.be.null;
        ...
        it('should return null for non-HEREDOC command', () => {
            const result: HeredocParseResult | null = parseHeredoc('cat file.txt');
    ...
    describe('isInlineHeredoc', () => {
        it('should detect inline HEREDOC', () => {
            const result: boolean = isInlineHeredoc('cat << EOF\nline1\nEOF');
            expect(result).to.be.true;
        });

        it('should return false for regular command', () => {
            const result: boolean = isInlineHeredoc('cat file.txt');
    ...
    describe('parseInlineHeredoc', () => {
        it('should parse inline HEREDOC', () => {
            const result: InlineHeredocResult | null = parseInlineHeredoc('cat << EOF\nline1\nline2\nEOF');
            expect(result).to.not.be.null;
            expect(result!.command).to.equal('cat');
        ...
        it('should parse inline HEREDOC with different delimiter', () => {
            const result: InlineHeredocResult | null = parseInlineHeredoc('grep test << END\nline1\ntest line\nEND');
            expect(result).to.not.be.null;
        ...
        it('should return null for non-inline HEREDOC', () => {
            const result: InlineHeredocResult | null = parseInlineHeredoc('cat file.txt');
            expect(result).to.be.null;
        });
