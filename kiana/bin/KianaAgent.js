...
const OpenAI = openai_1.default.OpenAI || openai_1.default;
/**
 ...
 */
async function streamExchange(client, params, writer, verbose = false) {
...
async function runKiana(options, memtools, writer) {
    ...
    if (!apiKey) {
        throw new Error('OPENAI_API_KEY must be set in environment or passed via options.apiKey');
    }
