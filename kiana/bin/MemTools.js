...
class MemTools {
     ...
     */
    constructor(fs) {
        this.shell = new MemShell_1.MemShell(fs);
     ...
     */
    reset() {
        this.fs = new MemFS_1.MemFS();
        this.shell = new MemShell_1.MemShell(this.fs);
    }
    /**
