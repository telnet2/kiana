...
function wc(context, args, stdin = null) {
...
function countString(content, showAll, countLines, countWords, countBytes, countChars, showMaxLength) {
    // Count lines
...
function formatOutput(stats, filePath, showAll, countLines, countWords, countBytes, countChars, showMaxLength) {
    const parts = [];
