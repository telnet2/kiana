...
function handleSingleImport(sourcePath: string, destPath: string | null, context: CommandContext, recursive: boolean): string {
...
function handleWildcardImport(pattern: string, destPath: string | null, context: CommandContext, recursive: boolean): string {
