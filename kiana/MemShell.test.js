...
const MemShell_1 = require("../lib/MemShell");
describe('MemShell - Shell Commands', () => {
    let shell;
    beforeEach(() => {
        shell = new MemShell_1.MemShell();
    });
    describe('ls command', () => {
        it('should list files in current directory', () => {
            ...
            (0, chai_1.expect)(output).to.include('file1.txt');
            (0, chai_1.expect)(output).to.include('file2.txt');
            (0, chai_1.expect)(output).to.include('dir1');
        });
        it('should list with long format (-l flag)', () => {
            shell.fs.createFile('file.txt', 'content');
            const output = shell.exec('ls -l');
            (0, chai_1.expect)(output).to.match(/-rwxr-xr-x/);
            (0, chai_1.expect)(output).to.include('file.txt');
        });
        it('should list specific directory', () => {
            ...
            (0, chai_1.expect)(output).to.include('inner.txt');
        });
    });
    describe('cat command', () => {
        it('should display file contents', () => {
            ...
            (0, chai_1.expect)(output).to.equal('Hello World');
        });
        it('should concatenate multiple files', () => {
            ...
            (0, chai_1.expect)(output).to.equal('HelloWorld');
        });
        it('should throw error for non-existent file', () => {
            (0, chai_1.expect)(() => shell.exec('cat nonexistent.txt')).to.throw();
        });
        it('should throw error for directory', () => {
            shell.fs.createDirectory('dir');
            (0, chai_1.expect)(() => shell.exec('cat dir')).to.throw(/Is a directory/);
        });
    });
    describe('pwd command', () => {
        ...
        it('should show current directory after cd', () => {
            ...
            shell.exec('cd test');
            const output = shell.exec('pwd');
            (0, chai_1.expect)(output).to.equal('/test');
        });
    });
    describe('cd command', () => {
        it('should change directory', () => {
            shell.fs.createDirectory('test');
            shell.exec('cd test');
            (0, chai_1.expect)(shell.fs.getCurrentDirectory()).to.equal('/test');
        });
        it('should go to root with no arguments', () => {
            shell.fs.createDirectory('test');
            shell.exec('cd test');
            shell.exec('cd');
            (0, chai_1.expect)(shell.fs.getCurrentDirectory()).to.equal('/');
        });
        it('should throw error for non-existent directory', () => {
            (0, chai_1.expect)(() => shell.exec('cd nonexistent')).to.throw();
        });
    });
    describe('mkdir command', () => {
        it('should create directory', () => {
            ...
            (0, chai_1.expect)(node).to.not.be.null;
            (0, chai_1.expect)(node.isDirectory()).to.be.true;
        });
        ...
        it('should create multiple directories', () => {
            ...
            (0, chai_1.expect)(shell.fs.resolvePath('dir1')).to.not.be.null;
            (0, chai_1.expect)(shell.fs.resolvePath('dir2')).to.not.be.null;
            (0, chai_1.expect)(shell.fs.resolvePath('dir3')).to.not.be.null;
        });
    });
    describe('touch command', () => {
        it('should create empty file', () => {
            ...
            (0, chai_1.expect)(node).to.not.be.null;
            (0, chai_1.expect)(node.isFile()).to.be.true;
            (0, chai_1.expect)(node.read()).to.equal('');
        });
        it('should update timestamp of existing file', (done) => {
            ...
            setTimeout(() => {
                ...
                (0, chai_1.expect)(node.modifiedAt.getTime()).to.be.greaterThan(oldTime.getTime());
                done();
            }, 10);
        });
    });
    describe('rm command', () => {
        it('should remove file', () => {
            ...
            (0, chai_1.expect)(shell.fs.resolvePath('test.txt')).to.be.null;
        });
        it('should remove directory with -r flag', () => {
            shell.fs.createDirectory('dir');
            shell.fs.createFile('dir/file.txt', '');
            shell.exec('rm -r dir');
            (0, chai_1.expect)(shell.fs.resolvePath('dir')).to.be.null;
        });
        it('should throw error removing non-empty directory without -r', () => {
            shell.fs.createDirectory('dir');
            shell.fs.createFile('dir/file.txt', '');
            (0, chai_1.expect)(() => shell.exec('rm dir')).to.throw();
        });
    });
    ...
    describe('grep command', () => {
        ...
        it('should find matching lines', () => {
            ...
            (0, chai_1.expect)(output).to.include('Hello World');
            (0, chai_1.expect)(output).to.include('Hello Again');
            (0, chai_1.expect)(output).to.not.include('Foo Bar');
        });
        ...
        it('should show line numbers with -n flag', () => {
            ...
            (0, chai_1.expect)(output).to.match(/1:Hello World/);
            (0, chai_1.expect)(output).to.match(/3:Hello Again/);
        });
    });
    describe('find command', () => {
        ...
        it('should find all files and directories', () => {
            ...
            (0, chai_1.expect)(output).to.include('/a');
            (0, chai_1.expect)(output).to.include('/a/file1.txt');
            (0, chai_1.expect)(output).to.include('/a/b');
            (0, chai_1.expect)(output).to.include('/a/b/file2.js');
        });
        it('should filter by name pattern', () => {
            const output = shell.exec('find a -name *.txt');
            (0, chai_1.expect)(output).to.include('file1.txt');
            (0, chai_1.expect)(output).to.include('test.txt');
            (0, chai_1.expect)(output).to.not.include('file2.js');
        });
        it('should filter by type (files only)', () => {
            const output = shell.exec('find a -type f');
            (0, chai_1.expect)(output).to.include('file1.txt');
            (0, chai_1.expect)(output).to.include('file2.js');
            (0, chai_1.expect)(output).to.not.include('/a/b\n'); // directory
        });
        it('should filter by type (directories only)', () => {
            const output = shell.exec('find a -type d');
            (0, chai_1.expect)(output).to.include('/a');
            (0, chai_1.expect)(output).to.include('/a/b');
            (0, chai_1.expect)(output).to.not.include('file1.txt');
        });
    });
    describe('sed command', () => {
        it('should substitute text in file', () => {
            ...
            (0, chai_1.expect)(output).to.equal('Hello Universe');
        });
    ...
    describe('write command', () => {
        it('should write content to new file', () => {
            ...
            (0, chai_1.expect)(node.read()).to.equal('Hello World');
        });
        it('should overwrite existing file', () => {
            shell.fs.createFile('test.txt', 'old content');
            shell.exec('write test.txt new content');
            const node = shell.fs.resolvePath('test.txt');
            (0, chai_1.expect)(node.read()).to.equal('new content');
        });
    });
    describe('node command', () => {
        it('should execute JavaScript file', () => {
            ...
            (0, chai_1.expect)(output).to.equal('Hello from script');
        });
        it('should handle console methods', () => {
            ...
            `);
            const output = shell.exec('node script.js');
            (0, chai_1.expect)(output).to.include('log message');
            (0, chai_1.expect)(output).to.include('ERROR: error message');
            (0, chai_1.expect)(output).to.include('WARN: warn message');
        });
        it('should provide process.argv', () => {
            ...
            (0, chai_1.expect)(output).to.include('arg1 arg2');
        });
        it('should support require for memory filesystem modules', () => {
            ...
            (0, chai_1.expect)(output).to.equal('42');
        });
    });
    describe('Command parsing', () => {
        it('should parse flags correctly', () => {
            const { flags, positional } = shell.parseArgs(['-l', '-a', 'test']);
            (0, chai_1.expect)(flags.l).to.be.true;
            (0, chai_1.expect)(flags.a).to.be.true;
            (0, chai_1.expect)(positional[0]).to.equal('test');
        });
        it('should parse long flags', () => {
            const { flags } = shell.parseArgs(['--name', 'test.txt']);
            (0, chai_1.expect)(flags.name).to.equal('test.txt');
        });
    ...
    describe('Pipes', () => {
        it('should pipe cat to grep', () => {
            ...
            (0, chai_1.expect)(output).to.include('line2 error');
            (0, chai_1.expect)(output).to.include('line4 error');
            (0, chai_1.expect)(output).to.not.include('line1');
            (0, chai_1.expect)(output).to.not.include('line3');
        });
    ...
    describe('Output Redirection', () => {
        ...
        it('should append to file with >>', () => {
            ...
            const node = shell.fs.resolvePath('test.txt');
            (0, chai_1.expect)(node.read()).to.equal('line 1\nline 2');
        });
        it('should create file if it does not exist with >>', () => {
            shell.exec('echo first line >> newfile.txt');
            const node = shell.fs.resolvePath('newfile.txt');
            (0, chai_1.expect)(node.read()).to.equal('first line');
        });
        it('should redirect cat output to file', () => {
            ...
            (0, chai_1.expect)(node.read()).to.equal('file contents');
        });
        it('should redirect grep output to file', () => {
            ...
            (0, chai_1.expect)(node.read()).to.equal('error here');
        });
        it('should redirect piped output to file', () => {
            ...
            (0, chai_1.expect)(node.read()).to.equal('baz bar baz');
        });
        it('should handle HEREDOC with output redirection (POSIX)', () => {
            ...
            (0, chai_1.expect)(node.read()).to.equal('server: localhost\nport: 8080');
        });
        it('should handle HEREDOC with append redirection', () => {
            ...
            (0, chai_1.expect)(node.read()).to.equal('existing line\nnew line 1\nnew line 2');
        });
        it('should handle multiple files in HEREDOC output redirection', () => {
            ...
            (0, chai_1.expect)(node.read()).to.include('console.log("Hello")');
            (0, chai_1.expect)(node.read()).to.include('console.log("World")');
        });
    });
    describe('Error handling', () => {
        it('should throw error for unknown command', () => {
            (0, chai_1.expect)(() => shell.exec('unknowncommand')).to.throw(/command not found/);
        });
